...
import venice from "../assets/atlantis.jpg";
...
const LandingCard = () => {
  return (
    <section className="  md:w-full md:grid-cols-2 md:gap-4  justify-evenly items-center md:mx-auto  grid text-center pt-16 md:pt-20">
      ...
      <div className="md:text-4xl text-xl">Experience the Ultimate Escape with MASHPA</div>
       
       <div className="text-md font-thin w-3/4">Unforgettable Adventures, Dream Destinations, and Tailor-Made Experiences for Extraordinary Journeys"</div>
       <div className="rectangle-btn md:m-10 mx-2 w-3/6 md:ml-24 text-center rounded-md bg-gradient-to-r from-pink-600 to-red-400 bg-slate-500 max-w-sm ">button</div>
      </div>
      ...
      <div className="  relative justify-end flex md:pt-72 pt-52 m-4 z-0  mx-10 w-full">
        ...
        <div className="rounded-full flex items-center justify-center  p-1 h-52 w-52 md:h-64 md:w-64 bg-slate-200  absolute md:-bottom-4 bottom-2 left-40 z-10">
          <div className=" bg-slate-800  rounded-full h-full w-full flex justify-center items-center text-center relative">
            ...
            <img src={logo} alt="logo" className="h-8 w-8 bg-slate-400 items-center mx-auto"/>
