...
const Contact = () => {
  return (
    <div
    className="block max-w-md rounded-lg bg-purple-400 p-6 h-full shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
    <form>
